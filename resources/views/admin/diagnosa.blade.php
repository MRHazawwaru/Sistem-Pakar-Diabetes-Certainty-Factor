            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.diagnosa') }}" method="post">
                        ...
                        @role('Admin')
                        <label for=""><b><i class="mr-1 fas fa-user"></i> Nama</b></label>
                        <input type="text" class="mb-3 form-control w-50" name="nama">
                        @endrole

                        <p>Pilih gejala yang sedang dirasakan.</p>

                        <label for=""><b><i class="mr-1 fas fa-th"></i> Gejala-gejala</b></label>
                        ...
                        <div class="row">
                            @endif
                            <div class="col-md-6">
                                <div class="p-2 mb-2 border d-flex align-items-center justify-content-between">
                                    <div>
